/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6115fcc54d2e3ecd805797243e96b792)
// Runtime types generated with workerd@1.20260401.1 2026-04-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		CLOUD_ENDOWMENTS: KVNamespace;
		CLOUD_DB: D1Database;
		RATE_LIMIT_PREAUTH: RateLimit;
		RATE_LIMIT_STORAGE_READ: RateLimit;
		RATE_LIMIT_STORAGE_WRITE: RateLimit;
		RANGLE_CLIENT_ID: string;
		RANGLE_CLIENT_SECRET: string;
		JWT_SECRET: string;
		AUTH_SERVICE: Fetcher /* auth */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RANGLE_CLIENT_ID" | "RANGLE_CLIENT_SECRET" | "JWT_SECRET">> {}
}
